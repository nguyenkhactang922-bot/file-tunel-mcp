...
if ($Catalog.catalogVersion -ne "1.2.0") { throw "FMG-008 requires catalogVersion 1.2.0." }
if ($Catalog.tools.Count -ne 20) { throw "FMG-008 hardens existing tools and must not change tool count." }
