...
if ($Catalog.catalogVersion -ne "1.5.0") { throw "Unexpected catalogVersion: $($Catalog.catalogVersion)" }
...
$Tools = @($Catalog.tools)
if ($Tools.Count -ne 22) { throw "Expected 22 canonical tools, got $($Tools.Count)." }
