...
| FPA-003 | P1 | READY | FPA-002 | macOS has bounded tunnel crash restart/backoff/jitter/budget/cooldown parity, or cross-platform tunnel-parity claim is explicitly removed |
...
AUTHORITATIVE NEXT_EXACT_ACTION: CLAIM FPA-003 design gate for macOS bounded tunnel restart/backoff/cooldown parity.
