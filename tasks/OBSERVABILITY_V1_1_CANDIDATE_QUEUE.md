...
| V11-004 | READY | V11-003 | Component health model: server/tunnel/persistence/restart/backoff/tunnel-health signals; dashboard integration |
...
NEXT_EXACT_ACTION: claim V11-004. OBS-013 runs after V11-008.
